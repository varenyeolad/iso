...
public class RsrcURLStreamHandlerFactory implements URLStreamHandlerFactory {
  ...
  public URLStreamHandler createURLStreamHandler(String protocol) {
    ...
    if (chainFac != null) return chainFac.createURLStreamHandler(protocol);
    return null;
  }

  /**
   * Allow one other URLStreamHandler to be added. URL.setURLStreamHandlerFactory does not allow
   * multiple factories to be added. The chained factory is called for all other protocols, except
